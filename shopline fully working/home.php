...
?>
    ...
    <head>
        ...
        <title>SHOPLINE - eCommerce Website</title>

        <!--
    - favicon
  -->
        <link rel="shortcut icon" href="./assets/images/logo/icons8-s-64.png" type="image/x-icon">
                ...
                <form action="#">
                    ...
                    <div class="newsletter-header">
                        ...
                        <p class="newsletter-desc">
                            Subscribe the <b>SHOPLINE</b> to get latest products and discount update.
                        </p>
            ...
            <div class="header-main">
                ...
                <div class="container">
                    ...
                    <a href="#" class="header-logo">
                        <img src="./assets/images/logo/logo.png" alt="shopline logo" width="250" height="50">
                    </a>
                    ...
                    <div class="header-user-actions">
                        <div class="dropdown">
                            ...
                            <ul tabindex="-1" class="menu menu-compact dropdown-content mt-3 p-2 shadow bg-base-100 rounded-box w-52">
                                <li><a href="pop.html">Hello ,<?php echo $_SESSION['name']; ?> </a>
                                </li>
                        ...
                        <div class="dropdown">
                            <button class="btn btn-ghost btn-circle dropdown-toggle" type="button" data-toggle="dropdown">
                    ...
                    <ul class="menu-category-list">
                        ...
                        <li class="menu-category">
                            ...
                            <ul class="submenu-category-list" data-accordion>
                                ...
                                <li class="submenu-category">
                                    <a href="#" class="submenu-title">Gujarati</a>
                                </li>
                        ...
                        <li class="menu-category">
                            ...
                            <ul class="submenu-category-list" data-accordion>
                                ...
                                <li class="submenu-category">
                                    <a href="#" class="submenu-title">RUP &#8377;</a>
                                </li>
                            </ul>
                        </li>
                                    ...
                                    <div class="showcase">
                                        ...
                                        <div class="showcase-content">
                                            ...
                                            <p class="showcase-desc">
                                                Old Spice Swagger 2in1 Shampoo And Conditioner 12 Fl Oz, 12.000-Fluid Ounce 12 Ounces
                                            </p>
                                            ...
                                            <div class="countdown-box">
                                                ...
                                                <!--count down  -->
                                                <a href="https://logwork.com/countdown-7vis" class="countdown-timer" data-timezone="Asia/Kolkata" data-date="2022-04-28 24:00">Countdown</a>
                                ...
                                <div class="showcase-container">
                                    ...
                                    <div class="showcase">
                                        ...
                                        <div class="showcase-content">
                                            ...
                                            <a href="https://logwork.com/countdown-7vis" class="countdown-timer" data-timezone="Asia/Kolkata" data-date="2022-04-19 22:52">Countdown</a>
          ...
          -->
                        ...
                        <div class="testimonial">
                            ...
                            <div class="testimonial-card">
                                ...
                                <img src="./assets/images/DSC_0873.JPG" alt="alan doe" class="testimonial-banner" width="80" height="80">

                                <p class="testimonial-name">Parth Solanki</p>

                                <p class="testimonial-title">Softwer Devloper</p>
        ...
        <footer>
                ...
                <div class="container">
                    ...
                    <ul class="footer-nav-list">
                        ...
                        <li class="footer-nav-item flex">
                            ...
                            <a href="tel:+91 93270 49319" class="footer-nav-link">+91 93270 49319</a>
                        </li>
                        ...
                        <li class="footer-nav-item flex">
                            ...
                            <a href="solankiparth.sp1988@gmail.com" class="footer-nav-link">example@gmail.com</a>
                        </li>
            ...
            <div class="footer-bottom">
                ...
                <div class="container">
                    ...
                    <p class="copyright">
                        Copyright &copy; <a href="#">SHOPLINE</a> all rights reserved.
                    </p>
